  ...
  products: [
    {
      ...
      status: "published",
      seo_title: "Manufacturing Lead Generation Tool for CNC Teams | LeadRadar",
      seo_description: "LeadRadar helps CNC and manufacturing teams review public social conversations for sourcing, RFQ, MOQ, sample, and custom manufacturing signals.",
      published_at: now,
      created_at: now,
      updated_at: now
    },
    {
      ...
      payment_enabled: true,
      status: "published",
      seo_title: "Demand Research Tool for Public Comments and Search Queries | NeedRadar",
      seo_description: "NeedRadar Workflow Lab turns public comments, search queries, and field notes into structured need clusters before a product workflow is built.",
      published_at: now,
      created_at: now,
      updated_at: now
    }
